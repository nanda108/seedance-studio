...
Нумерация @ImageN — по порядку загрузки в Seedance для КОНКРЕТНОЙ сцены.
Не используй глобальный маппинг из project-brief напрямую.

Алгоритм перед сборкой каждого промпта:
1. Определи каких персонажей и окружение используешь В ЭТОЙ СЦЕНЕ
2. Присвой им @Image1, @Image2, @Image3... по порядку появления
3. Раскадровка = следующий свободный номер

Примеры:
  Макс + лес → @Image1=Макс, @Image2=лес, раскадровка=@Image3
  Макс + Моника + Сэр + лес → @Image1=Макс, @Image2=Моника, @Image3=Сэр, @Image4=лес, раскадровка=@Image5
  Макс + лого → @Image1=Макс, @Image2=лого, раскадровка=@Image3

Добавляй строку в промпт после референсов:
  Reference @Image[N] as storyboard reference for this scene — visual composition guide.

Если project-brief.md не найден — пиши @Image[?] и предупреди:
  "Уточни состав референсов этой сцены."
